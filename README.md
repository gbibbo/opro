...
- **Audio (Prototype):** ✅ **1.6 GB** (AMI: 5 files, VoxConverse: 5 files, AVA-Speech: 5 videos) - 15 samples total
- **Download Scripts:** ✅ Ready for full datasets (AMI, VoxConverse, AVA-Speech, AVA-ActiveSpeaker)
