#!/usr/bin/env python3
"""
Evaluate Silero-VAD on psychoacoustic condition variants.

Processes all 6,264 variants (SNR sweep + band-limiting) generated by
build_conditions.py and saves results to Parquet for comparison with Qwen2-Audio.

Input:
    - data/processed/conditions/conditions_manifest.parquet

Output:
    - results/silero_conditions.parquet (detailed predictions)
    - results/silero_conditions_summary.parquet (aggregated stats)
"""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Silero-VAD on psychoacoustic conditions")
    parser.add_argument(
        "--manifest",
        type=str,
    ...
    print("=" * 80)
    print("SILERO-VAD EVALUATION: Psychoacoustic Conditions")
    print("=" * 80)
    ...
    if summary_groups:
        ...
        summary_path = output_dir / "silero_conditions_summary.parquet"
